...
public struct ToolbarButtonOptions: OptionSet {
    ...
    static public let flipHorizontal = ToolbarButtonOptions(rawValue: 1 << 4)
    static public let flipVertical = ToolbarButtonOptions(rawValue: 1 << 5)

    static public let `default`: ToolbarButtonOptions = [counterclockwiseRotate, reset, ratio]
    static public let all: ToolbarButtonOptions = [counterclockwiseRotate, clockwiseRotate, reset, ratio, flipHorizontal, flipVertical]
}
